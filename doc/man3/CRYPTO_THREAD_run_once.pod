...
CRYPTO_atomic_add,
CRYPTO_MUTEX_create, CRYPTO_MUTEX_init, CRYPTO_MUTEX_lock,
CRYPTO_MUTEX_unlock, CRYPTO_MUTEX_destroy,
CRYPTO_CONDVAR_wait, CRYPTO_CONDVAR_create, CRYPTO_CONDVAR_init,
CRYPTO_CONDVAR_broadcast, CRYPTO_CONDVAR_destroy - OpenSSL thread support
...
CRYPTO_MUTEX_create() creates an architecture dependent mutex object.

=item *

CRYPTO_MUTEX_init() initializes a mutex object from CRYPTO_MUTEX_CREATE().

=item *

CRYPTO_MUTEX_lock() locks the mutex.

=item *

CRYPTO_MUTEX_unlock() unlocks the mutex.

=item *

CRYPTO_MUTEX_destroy() deinitializes the mutex and frees associated data

=item *

CRYPTO_CONDVAR_create() creates a conditional variable.

=item *

CRYPTO_CONDVAR_init() initializes a conditional variable.

=item *

CRYPTO_CONDVAR_wait() expects an acquired mutex and awaits a broadcast.

=item *

CRYPTO_CONDVAR_broadcast() executes a broadcast for a conditional variable.

=item *

CRYPTO_CONDVAR_destroy() deinitializes frees associated data with the
