...
static int test_kdf_argon2(void)
{
    int ret;
    EVP_KDF_CTX *kctx;
    OSSL_PARAM params1[3], params2[5], params3[6], params4[5], *p;
    unsigned char out[64], out2[64], out3[128];

    /* Single-threaded Argon2d. */

    static const unsigned char expected_res1[sizeof(out)] = {
    ...
    *p = OSSL_PARAM_construct_end();
    ...
    ret =
        ...
        && TEST_true(EVP_KDF_set_ctx_params(kctx, params1))
        && TEST_int_eq(EVP_KDF_derive(kctx, out, sizeof(out)), 1)
        && TEST_mem_eq(out, sizeof(out), expected_res1, sizeof(expected_res1));
    ...
    static const unsigned char expected_res2[sizeof(out2)] = {
    ...
    *p = OSSL_PARAM_construct_end();
    ...
    ret =
        TEST_ptr(kctx = get_kdfbyname(SN_argon2d))
        && TEST_true(EVP_KDF_set_ctx_params(kctx, params2))
        && TEST_int_eq(EVP_KDF_derive(kctx, out2, sizeof(out2)), 1)
        && TEST_mem_eq(out2, sizeof(out2), expected_res2, sizeof(expected_res2));
...
# if defined(OPENSSL_THREADS)
    ...
    static const unsigned char expected_res3[sizeof(out3)] = {
    ...
    *p = OSSL_PARAM_construct_end();
    ...
    ret =
        TEST_ptr(kctx = get_kdfbyname(SN_argon2d))
        && TEST_true(EVP_KDF_set_ctx_params(kctx, params3))
        && TEST_int_eq(EVP_KDF_derive(kctx, out3, sizeof(out3)), 1)
        && TEST_mem_eq(out3, sizeof(out3), expected_res3, sizeof(expected_res3));
    ...
    *p = OSSL_PARAM_construct_end();
    ...
    ret =
        TEST_ptr(kctx = get_kdfbyname(SN_argon2d))
        && TEST_true(EVP_KDF_set_ctx_params(kctx, params4))
        && TEST_int_eq(EVP_KDF_derive(kctx, out3, sizeof(out3)), 0);
...
# endif
    ...
    *p = OSSL_PARAM_construct_end();
    ...
    ret =
        TEST_ptr(kctx = get_kdfbyname(SN_argon2d))
        && TEST_false(EVP_KDF_set_ctx_params(kctx, params4));
